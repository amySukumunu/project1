...
describe User do
  ...
  it"should reject email identical to upCase" do 
 ...
 describe "password validations" do 
    ...
    it "should reject short password" do 
    	short ="a" *5
    	short_user=@attr.merge(:password=>short,:password_confirmation => short)
    ...
    it "should have an encrypted password attribute" do
  	...
  	describe "same_password method" do 
  		it "should be true if the passwords match" do 
  			@user.same_password?(@attr[:password]).should be_true
  		end
  		
  		it "should be false if the passwords don't match" do 
  			@user.same_password?("invalid").should be_false
  		end
  	end
